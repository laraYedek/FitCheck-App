...
class ExerciseApp(QMainWindow):
    def __init__(self):
        ...
        self.counter = 0
        self.status = True
        self.exercise_type = "leg_lateral"  # Değiştirilecek egzersiz türü
        self.pose = mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5)
        self.countdown_time = QTime(0, 0, 5)  # 5 saniyelik geri sayım
        self.is_counting_down = False
        
        # Başlangıçta webcam beslemesini gizle
        self.image_label.hide()
        
    def start_exercise(self):
        self.video_cap = cv2.VideoCapture('Dene/leg_lateral_demo.mp4')  # Uygun bir demo video kullanın
    ...
    def update_video_frame(self):
        ...
        # Video çerçevesini webcam çerçeve boyutuna göre yeniden boyutlandır
    ...
    def overlay_countdown(self, frame):
        ...
        # Yarı saydam bir dikdörtgen arka plan olarak çiz
        overlay = frame.copy()
